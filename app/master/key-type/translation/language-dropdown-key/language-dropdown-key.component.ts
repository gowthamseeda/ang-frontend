...
@Component({
  selector: 'gp-language-dropdown-key',
  templateUrl: './language-dropdown-key.component.html',
  styleUrls: ['./language-dropdown-key.component.scss']
})
export class LanguageDropdownKeyComponent implements OnInit {
  ...
  constructor(private languageService: MasterLanguageService) {}
